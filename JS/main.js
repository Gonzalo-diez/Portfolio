...
sr.reveal('.home__data, .about__img, .skills__subtitle, .skills__text, .education, .education_text, .education_title',{}); 
sr.reveal('.home__img, .about__subtitle, .about__text, .skills__img, .education_img',{delay: 400}); 
